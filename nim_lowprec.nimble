...
description =
  "Zero-dependency low-precision numeric substrate (bf16/fp16/fp8/MXFP4/MXFP6/E8M0/int8/int4/int1) + quantization + NEON/AVX2 kernels for ML inference in Nim"
license = "MIT"
srcDir = "src"
...
task simd,
  "Run NEON SIMD tests (arm64; CI runs this on the macOS runners; x86 SIMD has its own workflow)":
