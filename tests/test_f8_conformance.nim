...
f8suite(
  F8E4M3, toF8E4M3, "fp8 e4m3fn (OCP)", "ref_e4m3_to_f32.bin", "ref_f32_to_e4m3.bin"
)
f8suite(
  F8E5M2, toF8E5M2, "fp8 e5m2 (OCP)", "ref_e5m2_to_f32.bin", "ref_f32_to_e5m2.bin"
)
f8suite(
  F8E4M3FNUZ, toF8E4M3FNUZ, "fp8 e4m3fnuz (AMD)", "ref_e4m3fnuz_to_f32.bin",
  "ref_f32_to_e4m3fnuz.bin",
)
f8suite(
  F8E5M2FNUZ, toF8E5M2FNUZ, "fp8 e5m2fnuz (AMD)", "ref_e5m2fnuz_to_f32.bin",
  "ref_f32_to_e5m2fnuz.bin",
)
