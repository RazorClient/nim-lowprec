...
func toMlDtypesName*(d: DType): string =
  ...
  case d
  of dtBF16:        "bfloat16"
  of dtF16:         "float16"          # native numpy (not an ml_dtypes ext)
  of dtF8E4M3:      "float8_e4m3fn"    # OCP e4m3fn (finite-only, one NaN).
                                       # NOT plain "float8_e4m3" — that is a
                                       # different variant this lib lacks.
  of dtF8E5M2:      "float8_e5m2"
  of dtF8E4M3FNUZ:  "float8_e4m3fnuz"
  of dtF8E5M2FNUZ:  "float8_e5m2fnuz"
  of dtE8M0:        "float8_e8m0fnu"   # MX shared-scale exponent code
  of dtF6E2M3:      "float6_e2m3fn"
  of dtF6E3M2:      "float6_e3m2fn"
  of dtF4E2M1:      "float4_e2m1fn"
  of dtI8:          "int8"             # native numpy
  of dtI4:          "int4"             # ml_dtypes ext. NOTE: numpy *core* has
                                       # no int4; `int4` exists only because
                                       # ml_dtypes registers it. Its range is
                                       # two's-complement -8..7, matching dtI4.
  of dtI1:          ""                 # GAP: no ml_dtypes/numpy 1-bit type
...
func fromMlDtypesName*(s: string): DType =
  ...
  of "bfloat16":        dtBF16
  of "float16":         dtF16
  of "float8_e4m3fn":   dtF8E4M3
  of "float8_e5m2":     dtF8E5M2
  of "float8_e4m3fnuz": dtF8E4M3FNUZ
  of "float8_e5m2fnuz": dtF8E5M2FNUZ
  of "float8_e8m0fnu":  dtE8M0
  of "float6_e2m3fn":   dtF6E2M3
  of "float6_e3m2fn":   dtF6E3M2
  of "float4_e2m1fn":   dtF4E2M1
  of "int8":            dtI8
  of "int4":            dtI4
  else:
    raise newException(ValueError,
      "no nim-lowprec DType for ml_dtypes name: '" & s & "'")
...
func toDLPack*(d: DType): DLPackType =
  ...
  case d
  of dtBF16:       (kDLBfloat, 16'u8, 1'u16)   # exact
  of dtF16:        (kDLFloat,  16'u8, 1'u16)   # exact
  ...
  of dtF4E2M1:     (kDLFloat,   4'u8, 1'u16)   # APPROX — see note
  of dtI8:         (kDLInt,     8'u8, 1'u16)   # exact
  of dtI4:         (kDLInt,     4'u8, 1'u16)   # exact (DLPack allows sub-byte int bits)
  of dtI1:         (kDLInt,     1'u8, 1'u16)   # APPROX — ±1 sign vs int1 {0,-1}
...
func toSafetensorsName*(d: DType): string =
  ...
  of dtBF16:        "BF16"
  of dtF16:         "F16"
  of dtF8E4M3:      "F8_E4M3"          # safetensors F8_E4M3 == OCP e4m3fn
  of dtF8E5M2:      "F8_E5M2"
  of dtI8:          "I8"
  of dtF8E4M3FNUZ:  ""                 # GAP: no fnuz variant
  of dtF8E5M2FNUZ:  ""                 # GAP: no fnuz variant
  of dtE8M0:        ""                 # GAP: no MX scale tag
  of dtF6E2M3:      ""                 # GAP: no F6 tag
  of dtF6E3M2:      ""                 # GAP: no F6 tag
  of dtF4E2M1:      ""                 # GAP: no F4 tag
  of dtI4:          ""                 # GAP: no I4 tag (packed into U8 elsewhere)
  of dtI1:          ""                 # GAP: BOOL is {0,1}, not ±1 sign
...
func fromSafetensorsName*(s: string): DType =
  ...
  of "I8":       dtI8
    ...
    raise newException(ValueError,
      "no nim-lowprec DType for safetensors dtype: '" & s & "'")
